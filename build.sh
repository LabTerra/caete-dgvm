...
python3 -m numpy.f2py -h caete_module.pyf global.f90 funcs.f90 productivity.f90 budget.f90 caete.f90 -m caete_module --overwrite-signature

## Spider man: - Finally, you compile the model (as a shared object or dll)
python3 -m numpy.f2py caete_module.pyf -c global.f90 funcs.f90 productivity.f90 budget.f90 caete.f90
