...
python3.8 -m numpy.f2py -h caete_module.pyf global.f90 utils.f90 soil_dec.f90\
...
python3.8 -m numpy.f2py caete_module.pyf -c global.f90 utils.f90 soil_dec.f90\
